...
// Used flexible tabbing system that might be used for elsewhere

/*public class MMEquipsBACKUP : MM_Super
{
    ...
    public void SelectItemList()
    {
        ...
        SelectWeaponTab(Selections.SelectItemInventory, BattleMaster.WeaponTypes.None, - 1, ItemInventoryFrame, InventoryItems, MenuManager.PartyInfo.Inventory.Items);
    }
    ...
    public void SelectBladeList()
    {
        ...
        SelectWeaponTab(Selections.SelectWeaponInventory, BattleMaster.WeaponTypes.Blade, 0, WeaponInventoryFrame, InventoryWeapons, wp);
    }
    ...
    public void SelectHammerList()
    {
        ...
        SelectWeaponTab(Selections.SelectWeaponInventory, BattleMaster.WeaponTypes.Hammer, 1, WeaponInventoryFrame, InventoryWeapons, wp);
    }
    ...
    public void SelectCharmList()
    {
        ...
        SelectWeaponTab(Selections.SelectWeaponInventory, BattleMaster.WeaponTypes.Charm, 2, WeaponInventoryFrame, InventoryWeapons, wp);
    }
    ...
    public void SelectGunList()
    {
        ...
        SelectWeaponTab(Selections.SelectWeaponInventory, BattleMaster.WeaponTypes.Gun, 3, WeaponInventoryFrame, InventoryWeapons, wp);
    }
    ...
    public void SelectBombList()
    {
        ...
        SelectWeaponTab(Selections.SelectWeaponInventory, BattleMaster.WeaponTypes.Tools, 4, WeaponInventoryFrame, InventoryWeapons, wp);
    }

    private void SelectWeaponTab<T>(Selections selection, BattleMaster.WeaponTypes wpnType, int tabIndex, MenuFrame frame, InventoryToolSelectionList toolListGUI, List<T> toolList) where T : ToolForInventory
    {
        Selection = selection;
        WeaponList = wpnType;
        if (tabIndex >= 0) EventSystem.current.SetSelectedGameObject(WeaponListTabs.transform.GetChild(tabIndex).gameObject);
        frame.Activate();
    ...
    private void EquipTool(InventoryToolSelectionList toolListGUI)
    {
        ...
        else if (SelectedEquippedList == InventorySystem.ListType.Weapons)
        {
            ...
            InventoryWeapons.Setup(MenuManager.PartyInfo.Inventory.Weapons.Where(x => x.WeaponType == WeaponList).ToList());
